...
| `safety.py` | Kill switch, circuit breakers, pre-trade validation (including an independent core-carve-out guard). |
| `engine.py` | The live loop: kill check -> broker truth -> reconcile -> breakers -> core bootstrap -> propose -> validate -> submit -> snapshot. |
